<template>
  <main class="page">
    ...
    <p>
      ...
      <a target="_blank" href="https://bytesandpipes.com">Bytes And Pipes</a>
      website ("Website" or "Service") and any of its related products and
      services (collectively, "Services"). This Agreement is between you
    ...
    <p>
      ...
      ownership or right to use of all submitted Content. Without limiting any
    ...
    <ul>
      ...
      <li>
        ...
        operation of the Website and Services, third party products and
      ...
      <li>
        to interfere with or circumvent the security features of the Website and
        Services, third party products and services, or the Internet.
      </li>
      <li>
        to infringe upon or violate intellectual property rights of others.
      </li>
    </ul>

    <h2>Termination clause</h2>
    <p>
      We reserve the right to terminate your use of the Website and Services for
    ...
    <p>
      ...
      email to <a href="mailto:devsojourn@pm.me">devsojourn@pm.me</a>.
    </p>
  </main>
</template>
